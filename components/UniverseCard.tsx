...
export default function UniverseCard() {
    return (
        <div className="bg-black border border-gray-800 rounded-3xl p-4 w-[20rem]">
            <h2 className="text-white text-2xl font-bold mb-4">Alam Semesta</h2>
            <div className="space-y-2 overflow-y-auto scrollbar-hide" style={{ maxHeight: 'calc(100vh - 235px)' }}>
